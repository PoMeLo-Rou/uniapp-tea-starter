  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: common_vendor.n(orderType.value === "dine" ? "active" : ""),
        c: common_vendor.o(($event) => orderType.value = "dine"),
        d: common_vendor.n(orderType.value === "takeout" ? "active" : ""),
        e: common_vendor.o(($event) => orderType.value = "takeout"),
        f: common_vendor.o(goDiy),
        g: common_vendor.f(orderItems.value, (item, index, i0) => {
          return common_vendor.e({
            ...
            e: common_vendor.t(item.spec || "冰(推荐),推荐,少甜(推荐),可降解吸管"),
            f: common_vendor.t(item.price),
            g: common_vendor.t(item.count),
            h: index
          });
        }),
        h: common_vendor.f(matchList.value, (m, i, i0) => {
          return {
        ...
        i: common_vendor.o(openCard),
        j: common_vendor.o(openCoupon),
        k: common_vendor.t(totalPrice.value),
        l: common_vendor.o(doPay)
      };
    };
  }
};
